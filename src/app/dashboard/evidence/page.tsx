...
export default function EvidenceUploadPage() {
  ...
  async function onUpload(files: File[]) {
    ...
    try {
      ...
      // Auto-run streaming processing to surface live progress
      log('Auto-start streaming processing');
      await processUploadStream({ fileName: file.name, fileContentBase64 });
    } catch (e: any) {
